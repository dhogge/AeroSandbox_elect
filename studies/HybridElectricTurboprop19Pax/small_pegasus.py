...
design_mass_TOGW = opti.variable(
    init_guess=7700, log_transform=True, lower_bound=4000, upper_bound=17000
)
...
m_midspan_motor_each = midspan_motor_power / motor_power_density  # 5 kW/kg
...
opti.subject_to(design_mass_TOGW <= 17000 * u.lbm)
